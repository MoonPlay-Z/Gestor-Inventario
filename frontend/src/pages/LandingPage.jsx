      ...
      <section id="inicio" style={{
        ...
        <div style={{ maxWidth: '850px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', color: '#64748b', fontSize: '0.8rem', fontWeight: 600 }}>
            ...
            <a href="https://www.linkedin.com/in/jadeveloper/" target="_blank" rel="noreferrer" style={{ color: '#94a3b8', backgroundColor: 'rgba(255,255,255,0.08)', padding: '8px', borderRadius: '50%', display: 'flex' }}>
